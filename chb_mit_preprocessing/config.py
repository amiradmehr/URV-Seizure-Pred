...
class PreprocessingConfig:
    ...
    def raw_data_dir(self) -> Path:
        ...
        ``src/dataset_downloads/CHB-MIT_download.py`` fetches the dataset
    ...
    def interim_data_dir(self) -> Path:
        ...
        return self.project_root / "data" / "CHB-MIT" / "interim"
    ...
    def processed_data_dir(self) -> Path:
        ...
        return self.project_root / "data" / "CHB-MIT" / "processed"
